...
class ArticleSearchSpecTest {
    ...
    void 정상적으로_제목으로_찾는_Specification을_생성한다() {
        Specification<Article> specificationByTitle = ArticleSearchSpec.getSpec("title", "test");
    ...
    void 정상적으로_작성자로_찾는_Specification을_생성한다() {
        Specification<Article> specificationByAuthor = ArticleSearchSpec.getSpec("author", "test");
    ...
    void 정상적으로_제목_또는_내용로_찾는_Specification을_생성한다() {
        Specification<Article> specificationByAuthor = ArticleSearchSpec.getSpec("titleWithContent", "test");
    ...
    void 올바르지_않은_타입으로_생성하려고하면_예외가_발생() {
        assertThrows(NotMatchArticleSearchKeyException.class, () -> ArticleSearchSpec.getSpec("test title", "test"));
    }
}